...
-->					
					...
					<p class="form-row-tip">You can separate name and subname by using a comma and a space.</p>
				</div>
			</div>
...
<!--
			...
			<div class="form-row">
				...
				<div class="ui multiple dropdown">
					...
					<span class="text">Filter by rarity.</span>
					<div class="menu">
						<div class="ui icon search input">
							<i class="search icon"></i>
							<input type="text" placeholder="Filter by rarity">
						</div>
						...
						<div class="scrolling menu">
							...
							<div class="item" data-value="Common">
								<div class="ui green empty circular label"></div>
								Common
							</div>
							<div class="item" data-value="Uncommon">
								<div class="ui yellow empty circular label"></div>
								Uncommon
							</div>
							<div class="item" data-value="Rare">
							...
							<div class="item" data-value="Chase">
								<div class="ui purple empty circular label"></div>
								Chase
							</div>
							<div class="item" data-value="Transmute">
								<div class="ui white empty circular label"></div>
								Transmute
							</div>
							<div class="item" data-value="Filmstrip Exclusive">
								<div class="ui black empty circular label"></div>
								Filmstrip Exclusive
							</div>
							<div class="item" data-value="Promo">
								<div class="ui blue empty circular label"></div>
								Promo
							</div>
							<div class="item" data-value="Signed">
